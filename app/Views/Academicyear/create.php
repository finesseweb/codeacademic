<!-- application/Views/academic_year/create.php -->
        ...
        <div class="col-lg-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="/academicyear/store">
                        <?= csrf_field() ?>
                        ...
                        <button type="submit" class="btn btn-gradient-primary btn-fw">Create</button>
                    </form>
                </div>
            </div>
        </div>
